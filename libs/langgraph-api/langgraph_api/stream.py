...
from langgraph_api.asyncio_utils import ValueEvent, wait_if_not_done
from langgraph_api.cli import langfuse_handler
...
async def astream_state(
    ...
    *,
    ...
    # 添加langfuse回调配置
    config.setdefault('callbacks', [langfuse_handler])
    # set up state
...
def get_feedback_urls(run_id: str, feedback_keys: list[str]) -> dict[str, str]:
    # {
    #     "accuracy": "https://example.com/feedback/12345/accuracy",
    #     "relevance": "https://example.com/feedback/12345/relevance",
    #     "helpfulness": "https://example.com/feedback/12345/helpfulness"
    # }
...
# @lru_cache(maxsize=1)
# def get_langfuse_client() -> langfuse.client:
