...
from langgraph_api.asyncio_utils import SimpleTaskGroup
from langgraph_api.cron_scheduler import cron_scheduler
from langgraph_api.graph import collect_graphs_from_env, stop_remote_graphs, collect_plugins_from_env
from langgraph_api.http_utils import start_http_client, stop_http_client, start_skill_client, stop_skill_client
from langgraph_api.metadata import metadata_loop
from langgraph_api.queue_utils import queue
...
async def lifespan(app: Starlette):
    ...
    await collect_plugins_from_env(True)
    try:
